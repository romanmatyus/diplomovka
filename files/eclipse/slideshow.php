...
<div class="flexslider">
	<ul class="slides">
        ...
        <li class="container row clr">

            <?php if ($Caption[$i] != null) {?>
            <div class="flex-image col span_6">
            	<img src="<?php echo $Image[$i] ?>" />
            </div>
            
            <div class="flex-caption col span_6">
                <?php echo $Caption[$i] ?>
                <?php if ($Link[$i] != null) {?><a href="<?php echo $Link[$i] ?>" class="more"><span><?php if ($More[$i] != null) { echo $More[$i];} else { echo 'Read more...'; }?></span></a><?php };?>
            </div>
            <?php } else { ?> 
			
            <div class="flex-single-image col span_12">
            	<img src="<?php echo $Image[$i] ?>" />
            </div>
